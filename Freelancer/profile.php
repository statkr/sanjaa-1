    ...
    if (!$validation->fails()) {
		...
		$freelancer->update([
		    ...
		    'username' => Input::get('username'),
				'freelancer_title' => Input::get('freelancer_title'),
        ...
        <section class="content">
		 ...
		 <?php if(isset($imageError)) { //If errors are found ?>
          ...
          <div class="col-lg-4">
			 ...
			 <a href="overview.php?a=profile" class="list-group-item">
	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['frontend']; ?> <?php echo $lang['overview']; ?>  
			 </a>
                  ...
                  <div class="form-group">
                   ...
                   <div class="input-group">
                    ...
                    <input type="text" name="username" class="form-control" value="<?php echo escape($username); ?>"/>
									...
									<div class="form-group">
									<label><?php echo "Your Title"; ?></label>
									 <div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input type="text" name="freelancer_title" class="form-control" value="<?php echo escape($freelancer_title); ?>" placeholder="Eg: Nodejs + ios Expert">
									 </div>
									</div>
