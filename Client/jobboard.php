	       ...
	       <div class="modal-dialog">
	        <div class="modal-content">
             ...
             <div class="modal-footer">
              ...
              //milestone id i will use to send to mtn
            $milestoneid_pay = $row->milestoneid ;
              ...
              <button style="text-shadow: hsla(0,0%,100%,.8) 0 1px ; border:1px solid #ccc ;background-image: linear-gradient(yellow,#be952c  85%,#be952c );color:#333 ;margin:10px 0px; " class="btn btn-md btn-info" data-toggle="modal" href="javascript:void(0)" onclick="openLoginModal('.$row->id.','.$row->budget.');">' . $lang['pay'] . ' ' . $lang['with'] . ' ' .'Mtn Momo</button>
              ';
						$delete .='
...
<!--  this the mtn payment modal code  -->
 <style type="text/css">
                              #loader {
   ...
   <div class="modal fade login" id="loginModal" style="z-index:2000">
       <div class="modal-dialog login animated">
           <div class="modal-content" style="width:400px">
              <div class="modal-header">
                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                     <h4 class="modal-title"><?php echo $lang['pay']; ?>&nbsp;<?php echo $lang['with']; ?>&nbsp;Mtn Momo</h4>
                 </div>
                 <div class="modal-body">
                     <div class="box">
                          <div class="content">
                             ...
                             <div class="form loginBox">
                                 ...
                                 <label for="tel" class="fa fa-phone">&nbsp;&nbsp;Mtn <?php echo $lang['phone']; ?></label>
                                 <input id="tel" name="_tel" placeholder="<?php echo $lang['phone']; ?>" class="field form-control" type="text" pattern="6[875][0-9]{7}">
                                 <input id="id" name="id" type="hidden">
                                 <input id="budget" name="budget" type="hidden">

                                 <button id="pay" onclick="loginAjax()" value="<?php echo $lang['phone']; ?>" class="btn" ><?php echo $lang['pay']; ?> &nbsp;<span id="amount_m"></span>Fcfa&nbsp;&nbsp;&nbsp;&nbsp;<div style="display:none ;" id="loader"></div></button>

                              
                              <p id="payinfo" class="btn-info" style="display:none ;margin-top:20px ;padding:10px ;">
                                Customer you have just <b>120 seconds</b> to confirm the payment.
                                please stay near your phone and cofirm<br/>
                                the payment by dialing <b>*126#</b>
                              </p>
                             </div>
                          </div>
                     </div>
      ...
      <script src="../local_payments/mtn_momo/ajax.js" type="text/javascript"></script>

<link rel="stylesheet" type="text/css" href="../local_payments/mtn_momo/modal.css">
