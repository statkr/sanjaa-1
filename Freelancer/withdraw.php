...
<body class="skin-green sidebar-mini">
	 ...
	 <section class="w">
	  ...
	  <div class="row">
	   ...
	   <?php endif; ?>
	  	...
	  	<?php if ($type === '2') : ?>
	  	<div class="col-lg-3">
         <a href="withdraw.php?id=2" class="">
         <div class="panel panel-default">
          <div class="panel-body text-center">
          <img style="width:100% ; height:200px ;" src="../local_payments/assets/mm.jpg"> 
	  	   <a href="withdraw.php?id=2" class="btn btn-success btn-block">Mtn Mobile Money</a>
	  	   <h4><?php echo $lang['selected']; ?></h4> 
	  	  </div>
	  	 </div>
	  	 </a> 
	   ...
	   <?php endif; ?>	 
	  	...
	  	<?php if ($type === '3') : ?>
	  	<div class="col-lg-3">
	  	<a href="withdraw.php?id=3" class="">
         <div class="panel panel-default">
          <div class="panel-body text-center">
          <img style="width:100% ; height:200px ;" src="../local_payments/assets/om.jpg"> 
	  	   <a href="withdraw.php?id=3" class="btn btn-success btn-block">Orange Mobile Money</a>
	  	   <h4><?php echo $lang['selected']; ?></h4> 
	  	  </div>
	  	 </div> 
	  	</a>
	 ...
	 <?php elseif (Input::get('id') === '2') : 
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">Mtn Mobile Money <?php echo $lang['withdrawal']; ?> <?php echo $lang['setup']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="addform"> 
                 	
                  <div class="form-group">	
				    <label><?php echo $lang['your']; ?> <?php echo $lang['phone']; ?></label>
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                    <input type="number" name="email" class="form-control" value="<?php
                         if (isset($_POST['data_stripe'])) {
							 echo escape(Input::get('email')); 
						  } else {
                  ...
                  <div class="form-group">	
				    <label><?php echo $lang['confirm']; ?> <?php echo $lang['phone']; ?></label>
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                    <input type="number" name="confirm_email" class="form-control"  value="<?php
                         if (isset($_POST['data_stripe'])) {
							 echo escape(Input::get('confirm_email')); 
						  } else {
                  ...
                  <div class="box-footer">
                    <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                    <button type="submit" name="data_stripe" style="background-color:#FECD1B ;" class="btn  full-width"><?php echo $lang['submit']; ?></button><br/><br />
                    <a href="withdraw.php" class="btn btn-info full-width"><?php echo $lang['back']; ?></a>
                  </div>
                 </form> 
                </div><!-- /.box-body -->
	 ...
	 <?php elseif (Input::get('id') === '3') : 
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title" style="color:#FF6600 ;">Orange Mobile Money <?php echo $lang['withdrawal']; ?> <?php echo $lang['setup']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="addform"> 
                  ...
                  <div class="box-footer">
                    <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                    <button style="background-color:#FF6600 ;" type="submit" name="data_skrill" class="btn btn-primary full-width"><?php echo $lang['submit']; ?></button><br/><br />
                    <a href="withdraw.php" class="btn btn-info full-width"><?php echo $lang['back']; ?></a>
                  </div>
                 </form> 
                </div><!-- /.box-body -->
